...
app=Crawler.new do |crawler|
  crawler.logger=STDOUT
  crawler.loglevel=Logger::DEBUG

  crawler.user_agent_alias='Mac Safari'
  crawler.proxy_addr='94.45.65.94'
  crawler.proxy_port=3128
